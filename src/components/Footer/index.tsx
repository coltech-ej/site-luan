...
import coltech from "../../../assets/capa_sem_texto_coltech_branco_branco.png";

export function Footer() {
	return (
		<Flex direction="column" as="footer" w="100%">
			<Flex>
				<Grid templateColumns="repeat(4, 1fr)" gap="5" my="12" mx="auto">
					<GridItem>
						<Flex>
					...
					<GridItem>
						<Flex direction="column" textAlign="left">
							...
							<Text fontSize="lg" color="gray.300" mt="5">
								Ficou alguma dúvida?
							</Text>
							<Text fontSize="lg" fontWeight="bold">
								robertgs3011@gmail.com
							</Text>
						</Flex>
					</GridItem>
			...
			>
				<Flex>
					...
					<Text fontSize="xs" fontWeight="400" color="gray.400">
						2022 Luan Hayder. All Rights Reserved
					</Text>
				</Flex>
				<Flex direction="row">
					<Flex
          ...
          >
            Desenvolvido por:
					...
					<Image src={coltech} alt="Coltech" w="42" h="10" />
				</Flex>
			</Flex>
		</Flex>
	);
